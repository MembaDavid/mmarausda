...
export default function ContactPage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-gradient-to-b from-emerald-950 via-teal-900 to-emerald-950 text-slate-100">
      ...
      <div className="pointer-events-none absolute inset-0">
        <motion.div
          ...
          className="absolute -top-24 -left-24 h-72 w-72 rounded-full bg-gradient-to-br from-emerald-500 via-teal-500 to-lime-400 blur-3xl"
        />
        <motion.div
          initial={{ opacity: 0, scale: 0.9 }}
          animate={{ opacity: 0.2, scale: 1 }}
          transition={{ duration: 1.2, delay: 0.15 }}
          className="absolute -bottom-24 -right-24 h-80 w-80 rounded-full bg-gradient-to-tr from-amber-400 via-yellow-400 to-emerald-400 blur-3xl"
        />
      </div>
        ...
        >
          ...
          <motion.div variants={item} className="flex flex-col justify-center">
            ...
            >
              ...
              <span className="mt-2 block text-base font-medium text-emerald-200/90 md:text-lg">
                Contact Us
              </span>
            </motion.h1>
          ...
          >
            ...
            <motion.button
              ...
              className="group mt-6 inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-emerald-600 via-teal-500 to-amber-500 px-5 py-3 font-medium text-white shadow-lg shadow-emerald-500/20 focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-300 disabled:opacity-60"
            >
              {status === "sending" ? (
                <Spinner />
              ) : (
    ...
    <label className={`block ${className}`}>
      ...
      <div className="relative">
        <select
          ...
          className="w-full appearance-none rounded-2xl border border-white/10 bg-white/5 px-4 py-3 pr-10 text-slate-100 outline-none transition focus:border-white/20 focus:bg-white/10 focus:ring-2 focus:ring-emerald-400/40"
        >
          {options.map((opt) => (
  ...
  return (
    <label className="flex items-center gap-3 text-sm text-slate-200">
      <input
        ...
        name={name}
        required={required}
        className="h-4 w-4 rounded border-white/20 bg-white/10 text-emerald-500 focus:ring-emerald-400/40"
      />
      <span>{label}</span>
    </label>
  );
  ...
  return (
    <label className="block">
      ...
      <textarea
        ...
        rows={rows}
        placeholder={placeholder}
        className="w-full resize-y rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-slate-100 placeholder-slate-300/80 outline-none transition focus:border-white/20 focus:bg-white/10 focus:ring-2 focus:ring-emerald-400/40"
      />
    </label>
  );
}
